...
urlpatterns = [
    url(r'^postgraduate/brief/list$', views.brief_list, name='brief_list_p'),
    ...
    url(r'^postgraduate/brief/(\d+)/delete', views.delete, name='brief_delete'),

    url(r'^teacher/brief/list$', views.brief_list, name='brief_list_t'),
